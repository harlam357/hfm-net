...
namespace HFM.Client.Tests.DataTypes
{
   ...
   public class UnitCollectionTests
   {
      ...
      public void FillTest6()
      {
         ...
         Assert.AreEqual(SlotStatus.Send, unitCollection[0].StateEnum);
         ...
         Assert.AreEqual(SlotStatus.Send, unitCollection[1].StateEnum);
         ...
         Assert.AreEqual(SlotStatus.Send, unitCollection[2].StateEnum);
         ...
         Assert.AreEqual(SlotStatus.Send, unitCollection[3].StateEnum);
         ...
         Assert.AreEqual(SlotStatus.Running, unitCollection[4].StateEnum);
