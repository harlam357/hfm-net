...
namespace HFM.Proteins
{
   ...
   {
      [Test]
      public void ProteinValidator_IsValid_ReturnsTrueWhenAllRequiredPropertiesArePopulated_Test()
      {
      ...
      [Test]
      public void ProteinValidator_IsValid_ReturnsFalseWhenProteinIsNull_Test()
      {
