...
namespace HFM.Forms
{
   ...
   public partial class HistoryForm : FormWrapper, IHistoryView
   {
      ...
      private void SetupDataGridView(IPreferenceSet prefs)
      {
         ...
         dataGridView1.Columns[WorkUnitRowColumn.PPD.ToString()].DefaultCellStyle = new DataGridViewCellStyle { Format = prefs.GetPpdFormatString() };
         ...
         dataGridView1.Columns[WorkUnitRowColumn.Credit.ToString()].DefaultCellStyle = new DataGridViewCellStyle { Format = prefs.GetPpdFormatString() };
