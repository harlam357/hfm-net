...
namespace HFM.Log
{
   public static class LogLineIdentifier
   {
      ...
      private static LogLineType DetermineLineTypeCommon(string logLine)
      {
      ...
      /// </summary>
      /// <param name="logLine">The raw log line being inspected.</param>
      private static LogLineType DetermineLineTypeLegacy(string logLine)
      {
      ...
      /// </summary>
      /// <param name="logLine">The raw log line being inspected.</param>
      private static LogLineType DetermineLineTypeFahClient(string logLine)
      {
