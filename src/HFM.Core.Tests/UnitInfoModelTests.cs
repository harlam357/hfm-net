...
namespace HFM.Core
{
   ...
   public class UnitInfoModelTests
   {
      ...
      public void FramesCompleteTest1()
      {
         ...
         unitInfo.AddWorkUnitFrame(new UnitRunFrameData { ID = 1 });
      ...
      {
         var unitInfo = new UnitInfo();
         unitInfo.AddWorkUnitFrame(new UnitRunFrameData { ID = 101 });
         var unitInfoLogic = CreateUnitInfoModel(null, unitInfo);
         unitInfoLogic.UtcOffsetIsZero = false;
         unitInfoLogic.ClientTimeOffset = 0;
      ...
      {
         var unitInfo = new UnitInfo();
         unitInfo.AddWorkUnitFrame(new UnitRunFrameData { ID = 5 });
         var unitInfoLogic = CreateUnitInfoModel(null, unitInfo);
         unitInfoLogic.UtcOffsetIsZero = false;
         unitInfoLogic.ClientTimeOffset = 0;
      ...
      public void PerUnitDownloadTest1()
      {
         ...
         unitInfo.AddWorkUnitFrame(CreateFrameData("00:00:00", 0));
         unitInfo.AddWorkUnitFrame(CreateFrameData("00:04:00", 1));
         unitInfo.AddWorkUnitFrame(CreateFrameData("00:09:00", 2));
         unitInfo.AddWorkUnitFrame(CreateFrameData("00:15:00", 3));
      ...
      {
         var unitInfo = new UnitInfo { DownloadTime = DateTime.UtcNow, FramesObserved = 4 };
         unitInfo.AddWorkUnitFrame(CreateFrameData("00:00:00", -1));
         var unitInfoLogic = CreateUnitInfoModel(null, unitInfo);
         unitInfoLogic.UtcOffsetIsZero = false;
         unitInfoLogic.ClientTimeOffset = 0;
      ...
      public void PerAllSectionsTest1()
      {
         ...
         unitInfo.AddWorkUnitFrame(CreateFrameData("00:00:00", 0));
         unitInfo.AddWorkUnitFrame(CreateFrameData("00:05:10", 1));
         unitInfo.AddWorkUnitFrame(CreateFrameData("00:11:30", 2));
         unitInfo.AddWorkUnitFrame(CreateFrameData("00:17:40", 3));
         unitInfo.AddWorkUnitFrame(CreateFrameData("00:24:00", 4));
         var unitInfoLogic = CreateUnitInfoModel(protein, unitInfo);
         unitInfoLogic.UtcOffsetIsZero = false;
         unitInfoLogic.ClientTimeOffset = 0;
      ...
      {
         var unitInfo = new UnitInfo();
         unitInfo.AddWorkUnitFrame(CreateFrameData("00:00:00", 100));
         var unitInfoLogic = CreateUnitInfoModel(null, unitInfo);
         unitInfoLogic.UtcOffsetIsZero = false;
         unitInfoLogic.ClientTimeOffset = 0;
      ...
      private static UnitRunFrameData CreateFrameData(string timeStamp, int frameId)
      {
         return new UnitRunFrameData
                {
                   ID = frameId,
