...
public class WorkUnitRowCsvFileSerializerTests
{
    ...
    public void BeforeEach()
    {
        ...
        _expected = "DatabaseID,ProjectID,ProjectRun,ProjectClone,ProjectGen,SlotName,ConnectionString,DonorName,DonorTeam,CoreVersion,FramesCompleted,FrameTime,Result,Assigned,Finished,KFactor,Core,Frames,Atoms,PreferredDays,MaximumDays,SlotType,PPD,Credit,BaseCredit";
