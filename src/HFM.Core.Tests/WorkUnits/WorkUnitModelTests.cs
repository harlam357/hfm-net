...
public class WorkUnitModelTests
{
    ...
    [Test]
    public void WorkUnitModel_GetFrameTime_FromProteinBenchmarkRepository()
    {
        var mockBenchmarkRepository = new Mock<IProteinBenchmarkRepository>();
        var benchmark = new ProteinBenchmark
        {
            FrameTimes = new List<ProteinBenchmarkFrameTime>
            {
                new()
                {
        ...
        mockBenchmarkRepository
            .Setup(x => x.GetBenchmark(It.IsAny<SlotIdentifier>(), It.IsAny<ProteinBenchmarkIdentifier>()))
            .Returns(benchmark);
        var workUnitModel = CreateWorkUnitModel(null, new WorkUnit(), mockBenchmarkRepository.Object);
